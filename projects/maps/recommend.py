...
def find_centroid(cluster):
    ...
    y_locations = [l[1] for l in locations]
    return [mean(x_locations), mean(y_locations)]
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    "*** YOUR CODE HERE ***"
    return max([find_predictor(user, reviewed, fn) for fn in feature_fns],
               key = lambda predictor: predictor[1])[0]
    # END Question 8
...
def rate_all(user, restaurants, feature_fns):
    ...
    # BEGIN Question 9
    "*** YOUR CODE HERE ***"
    dic = {restaurant_name(r):predictor(r) for r in restaurants} 
    for r in reviewed:
